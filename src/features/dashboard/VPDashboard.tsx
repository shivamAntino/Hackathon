...
const feedbacks = [
  ...
  {
    src: "https://cdn3.vectorstock.com/i/thumb-large/66/77/avatar-young-bearded-guy-brow-haired-man-vector-32416677.jpg",
    heading: "Noor Mohammad",
    title: "frontend developer",
    rating: "5",
  },
  {
    ...
    <>
      <div className="dashboard">
        ...
        <div className="dashboard-body">
          ...
          <div
            className="dashboard-body-feedbacks"
